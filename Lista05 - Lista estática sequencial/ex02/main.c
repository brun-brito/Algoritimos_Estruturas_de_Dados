...
int main(){
    ...
    do
    {
        ...
        do
        {
            ...
            printf(" 5. Excluir elemento ordenado\n");
            printf(" 6. Imprimir lista\n");
            printf(" 7. Obter elemento\n");
            printf(" 8. SAIR\n");
            printf(" Opcao: ");
            scanf("%d", &op);
            if ((op < 1) || (op > 8))
        ...
        case 4:
            ...
            if (insere_ordenado(lista, j) == 0){ // se tiver como inserir, sucesso
        ...
        case 5:
            printf("\n5. Excluir elemento ordenado\n\n");
            printf("Digite o elemento a ser removido: ");
            int x;
            scanf("%d", &x);
            if (remove_ordenado(lista, x) == 0){
        ...
        case 7:
            ...
            int y;
            scanf("%d",&y);
            if (obtem_valor_elem(lista, y) == y){
                printf("O valor %d esta na lista. Aperte qualquer tecla para continuar\n",y);
            }else{
                printf("O valor %d NAO esta na lista. Aperte qualquer tecla para continuar\n",y);
            }            
            getch();
            break;
